...
public:
	cAlquiler(cCliente* cliente, cVehiculo* vehiculo, int* cantadicionales, cFecha inicioreserva, cFecha finalreserva);//Monto total lo inicializamos en cero en la definicion del constructor
	~cAlquiler();
